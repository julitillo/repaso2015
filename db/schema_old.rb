...
ActiveRecord::Schema.define(version: 20141107215801) do
  ...
  create_table "lists", force: true do |t|
    ...
    t.integer  "traslation_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "lists", ["traslation_id"], name: "index_lists_on_traslation_id", using: :btree
  ...
  add_index "tests", ["dictionary_id"], name: "index_tests_on_dictionary_id", using: :btree
