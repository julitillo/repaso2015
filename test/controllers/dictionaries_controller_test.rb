...
class DictionariesControllerTest < ActionController::TestCase
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post :create, dictionary: { access: @dictionary.access, difficulty: @dictionary.difficulty, language_for_id: @dictionary.language_for_id, language_own_id: @dictionary.language_own_id, title: @dictionary.title, user_id: @dictionary.user_id }
    end
  ...
  test "should update dictionary" do
    patch :update, id: @dictionary, dictionary: { access: @dictionary.access, difficulty: @dictionary.difficulty, language_for_id: @dictionary.language_for_id, language_own_id: @dictionary.language_own_id, title: @dictionary.title, user_id: @dictionary.user_id }
    assert_redirected_to dictionary_path(assigns(:dictionary))
  end
