...
class TranslationsControllerTest < ActionController::TestCase
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post :create, translation: { aception_for_id: @translation.aception_for_id, aception_own_id: @translation.aception_own_id }
    end
  ...
  test "should update translation" do
    patch :update, id: @translation, translation: { aception_for_id: @translation.aception_for_id, aception_own_id: @translation.aception_own_id }
    assert_redirected_to translation_path(assigns(:translation))
  end
